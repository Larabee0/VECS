...
layout (set = 1, binding = 0) uniform sampler2D uAreaTexture;
layout (set = 1, binding = 1) uniform sampler2D uSearchTexture;
layout (set = 1, binding = 2) uniform sampler2D uEdgeTexture;
