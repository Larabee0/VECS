...
namespace VECS
{
    public sealed class ShadowImage
    {
        ...
        internal unsafe void ClearImage(RendererFrameInfo frameInfo)
        {
            ...
            var existing = CubeMap.ImageLayout;
            ...
            {
                CubeMap.SetImageLayout(frameInfo.CommandBuffer, VkImageLayout.TransferDstOptimal, VkPipelineStageFlags2.ColorAttachmentOutput, VkPipelineStageFlags2.Transfer);
            }
