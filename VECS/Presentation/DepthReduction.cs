...
namespace VECS.Presentation
{
    public static class DepthReduction
    {
        ...
        private static void RecreateImage()
        {
            ...
            int swapChainWidth = (int)SwapChain.Instance._windowExtent.width;
            int swapChainHeight = (int)SwapChain.Instance._windowExtent.height;
        ...
        public static unsafe void ReduceDepth(RendererFrameInfo frameInfo)
        {
            ...
            depthTexture.SetImageLayout(frameInfo.CommandBuffer, VkImageLayout.ShaderReadOnlyOptimal, VkPipelineStageFlags2.LateFragmentTests, VkPipelineStageFlags2.ComputeShader);
            ...
            for (int i = 0; i < depthPryamid.MipMapCount; i++)
            {
                ...
                _depthReduceShader.PushConstantsHandler.SetPushConstantVector2("imageSize", new(levelWidth,levelHeight));
