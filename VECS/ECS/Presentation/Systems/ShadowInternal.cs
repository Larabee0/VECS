...
#pragma warning restore CS0162
            ...
            CullData cullDataInternal = new(ShadowImage.SHADOW_CULLING, ShadowImage.SHADOW_DST_CULLING, ShadowImage.SHADOW_DEPTH_CULLING,frameInfo.CullData.zNear, viewMatrix * proj,viewMatrix);
